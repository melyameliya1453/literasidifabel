...
<title><?php echo $datauseruser["nama_user"];?> | Notifikasi Komentar - Literasi Difabel</title>
                            ...
                            while ($datakomennya = mysqli_fetch_array($querykomentarnya)) {
                                ...
                                if ($datakomennya["lihat_komentar"] == 1 && $datakomennya["penulis_komentar"] !== $_SESSION["user"]) { ?>
                                    <div class='alert alert-warning'>
                                        <small><?php echo $datakomennya["tanggal_komentar"];?></small>
                                        <br>
                                        <i class='fa fa-comment-o'></i>  
                                        <span class="badge">Baru!</span> 

                                        <?php if ($datakomentar["pp_user"] == '') { ?>
                                            <img src="<?php echo home_base_url(); ?>assets/img/user/<?php echo $datakomentar["pp_user"];?>" style="width:25px;height:25px;border-radius:100%;">
                                        <?php } else { ?>
                                            <img src="<?php echo home_base_url(); ?>assets/img/user/<?php echo $datakomentar["pp_user"];?>" style="width:25px;height:25px;border-radius:100%;">
                                        <?php } ?>

                                        <b>
                                            <a href="./?p=user&user=<?php echo $datakomennya["penulis_komentar"];?>">
                                                @<?php echo $datakomennya["penulis_komentar"];?>
                                            </a>
                                        </b> 
                                        ...
                                        <b>
                                            <a href="./?p=post&id=<?php echo $datapostnya["id_post"];?>&post_by=<?php echo $datapostnya["penulis_post"];?>#komentar_<?php echo $datakomennya["id_komentar"];?>">
                                                <?php echo $judulpostnya;?>
                                            </a>
                                        </b> 
                                        Kamu
                                    </div>

                                <?php } elseif ($datakomennya["penulis_komentar"] !== $_SESSION["user"]){ ?>
