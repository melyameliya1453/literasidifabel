            ...
            <div class="col-md-9 col-lg-9">
                <div class="page-inner">
                    <div class="alert alert-default alert-title-area">
                        ...
                        <span style="float:right;">
                            ...
                            ?>
                                ...
                                <a class="btn btn-danger btn-xs" href="#" onclick="window.location='<?php echo home_base_url(); ?>inc/unlike.php?id=<?php echo $idpost;?>&u=<?php echo $datapost["penulis_post"];?>';">
                                    <i class="fa fa-heart"></i> Unlike
                                </a>

                            <?php } else { ?>
                            
                                <a class="btn btn-primary btn-xs" href="#" onclick="window.location='<?php echo home_base_url(); ?>inc/like.php?id=<?php echo $idpost;?>&u=<?php echo $datapost["penulis_post"];?>';">
                    ...
                    <div>
                        ...
                        <a href="<?php echo home_base_url(); ?>assets/img/post/<?php echo $datapost["gambar_post"];?>">
                            <img src="<?php echo home_base_url(); ?>assets/img/post/<?php echo $datapost["gambar_post"];?>" class="img-responsive" style="margin-bottom: 15px;     border-radius: 4px;">
                        </a>
                    </div>
                    ...
                    <?php } if (@$_SESSION["user"]) { ?>
                        ...
                        <form method="post" action="<?php echo home_base_url(); ?>inc/ngomen.php?p=<?php echo $datapost["id_post"];?>&a=<?php echo $datapost["penulis_post"];?>" id="komentar" style="margin-top: 15px;">
                    ...
                    <?php } else { ?>
                        <a href="<?php echo home_base_url(); ?>login?post=<?php echo $url;?>?p=post&id=<?php echo$datapost["id_post"];?>&post_by=<?php echo $datapost["penulis_post"];?>">
                            <i class="fa fa-sign-in"></i> Masuk Untuk Ngomen!
                        </a>
                    <?php } ?>
                            ...
                            if ($totalkomentar >= 0) {
                                while ($datakomentar = mysqli_fetch_array($querykomentar)) { ?>
                                    ...
                                    <b>
                                        <a href="./?p=user&user=<?php echo $datakomentar["penulis_komentar"];?>">
                                            <?php if ($datakomentar["pp_penulis"] == '') { ?>
                                                <img src="<?php echo home_base_url(); ?>assets/img/user/<?php echo $datakomentar["pp_penulis"];?>" style="width:25px;height:25px;border-radius:100%;">
                                            <?php } else { ?>
                                                <img src="<?php echo home_base_url(); ?>assets/img/user/<?php echo $datakomentar["pp_penulis"];?>" style="width:25px;height:25px;border-radius:100%;">
                                            <?php 
                                                }
                                    ...
                                    <?php if (@$_SESSION["user"] == @$datapost["penulis_post"]) { ?>
                                        <a href="<?php echo home_base_url(); ?>inc/hapus-komentar?id=<?php echo $datakomentar["id_komentar"];?>" style="float:right;" class="abc" title="Hapus Komentar" onclick="return confirm('Hapus Komentar Ini Dari Postingan Kamu?')">
                                            X
                                        </a>

                                    <?php } elseif(@$datakomentar["penulis_komentar"] == @$data2["user_user"]){ ?>
                                        <a href="<?php echo home_base_url(); ?>inc/hapus-komentar?id=<?php echo $datakomentar["id_komentar"];?>" style="float:right;" class="abc" title="Hapus Komentar" onclick="return confirm('Hapus Komentar Kamu?')">
                                            X
                                        </a>
