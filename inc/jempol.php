...
<title><?php echo $datauseruser["nama_user"];?> | Notifikasi Like - Literasi Difabel</title>
                            ...
                            while ($datakomennya = mysqli_fetch_array($querykomentarnya)) {
                                ...
                                if ($datakomennya["lihat_suka"] == 1) { ?>
                                    ...
                                    <div class='alert alert-warning'>
                                        <small><?php echo $datakomennya["tanggal_suka"];?></small>
                                        <br>
                                        ...
                                        <b>
                                            <a href="./?p=user&user=<?php echo $datakomennya["user_suka"];?>">
                                                @<?php echo $datakomennya["user_suka"];?>
                                            </a>
                                        </b> 

                                        Ngasih Jempol Pada Postingan 

                                        <b>
                                            <a href="./?p=post&id=<?php echo $datapostnya["id_post"];?>&post_by=<?php echo $datapostnya["penulis_post"];?>">
                                ...
                                <?php } elseif ($datakomennya["user_suka"] !== $_SESSION["user"]) { ?>
